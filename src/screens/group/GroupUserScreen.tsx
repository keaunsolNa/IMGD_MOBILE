...
export default function GroupUserScreen({ route }: any) {
  const { groupNm, userId } = route.params;
    ...
    return (
      <View style={styles.container}>
        <View style={styles.header}>
          ...
          <Text style={styles.subTitle}>사용자 정보를 불러오는 중...</Text>
        </View>
      </View>
    );
  }
  ...
  if (!user) {
    return (
      <View style={styles.container}>
        <View style={styles.header}>
          <Text style={styles.groupTitle}>{groupNm}</Text>
          <Text style={styles.subTitle}>사용자 정보를 불러올 수 없습니다</Text>
        </View>
      </View>
    );
  }
  ...
  return (
    <View style={styles.container}>
      <View style={styles.header}>
        <Text style={styles.groupTitle}>{groupNm}</Text>
        <Text style={styles.subTitle}>사용자 상세 정보</Text>
      </View>
